`timescale 1ns/1ps
// ============================================================
// Module  : top_adaptive_no_residue
// Project : Self-Healing Digital Circuit
// Description:
//   Adaptive Redundancy WITHOUT residue-based fault localization.
//   Uses VOTER_ONLY quarantine policy: faults are detected only
//   through voter disagreement, not through residue checking.
//
//   This is the "Adaptive (No Quarantine, No Residue)" variant
//   used for comparison against the full residue-aware version.
//
//   Modes:
...
module top_adaptive_no_residue #(
    parameter integer QUAR_POLICY      = 1,  // VOTER_ONLY
    ...
    // --------------------------------------------------------
    // Residue-based verifiers (instantiated but not used
    // for quarantine policy in this variant).
    // --------------------------------------------------------
    ...
    always @(*) begin
        ...
        // NO residue-based detection in this variant; only voter events
        residue_event[0] = 1'b0;
        residue_event[1] = 1'b0;
        residue_event[2] = 1'b0;
        residue_event[3] = 1'b0;
        residue_event[4] = 1'b0;
